...
{
    private DatabaseReference ProductsRef,likereference;
                                ...
                                likereference.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                                        ...
                                        if (likecheker.equals(true))
                                        {
                                            ...
                                            {
                                                likereference.child(postkey).child(curerntUserId).removeValue();
                                                likecheker=false;

                                            }else
                                                {
                                                    likereference.child(postkey).child(curerntUserId).setValue(true);
                                                    likecheker=false;
